  ...
  return (
    <>
      <div className="bg-gradient-to-br from-blue-100 to-white min-h-screen">
        ...
        <header className="flex justify-between items-center px-6 md:px-10 py-5 shadow-lg bg-white  fixed top-0 left-0 w-full z-50">
          ...
          >
            <a
              href="#features"
              className="text-sm md:text-base text-gray-700 hover:text-blue-600"
            >
              Features
            </a>
            <a
            ...
            <button className="px-4 py-2 text-sm md:text-base border border-blue-600 text-blue-600 rounded hover:bg-blue-600 hover:text-white">
              Login
            </button>
          </nav>
          ...
          {/* Mobile Menu */}
          <div
            className={`fixed top-0 left-0 w-3/4 h-full bg-white shadow-md transform transition-all md:hidden ${
          ...
          >
            ...
            <nav className="flex flex-col space-y-6 px-6 py-4">
              ...
              <button className="px-4 py-2 text-sm border border-blue-600 text-blue-600 rounded hover:bg-blue-600 hover:text-white">
                Login
              </button>
            </nav>
          </div>
